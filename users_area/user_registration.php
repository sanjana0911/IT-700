...
if(isset($_POST['user_register']))
{
    ...
    {     
    $insert_query = "insert into `user_table`( username, user_email, user_password,address, mobile,user_ipaddress ) values  ('$user_username','$user_email','$hash_password','$address','$contact','$user_ipaddress')";
